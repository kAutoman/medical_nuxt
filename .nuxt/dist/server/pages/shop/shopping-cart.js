...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/vue-loader/lib??vue-loader-options!./pages/shop/shopping-cart.vue?vue&type=template&id=5f1d8758&



var shopping_cartvue_type_template_id_5f1d8758_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "ps-shopping"
  }, [_vm._ssrNode("<div class=\"container\">", "</div>", [_c('breadcrumb', {
    attrs: {
      "dataList": _vm.breadcrumb
    }
  }), _vm._ssrNode(" <h3 class=\"ps-shopping__title\">Shopping cart<sup>" + _vm._ssrEscape("(" + _vm._s(_vm.productCartQuantity) + ")") + "</sup></h3> "), _vm._ssrNode("<div class=\"ps-shopping__content\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-12 col-sm-7 col-md-9\">", "</div>", [_vm._ssrNode("<ul class=\"ps-shopping__list\">", "</ul>", _vm._l(_vm.cartProducts, function (product, index) {
  ...
  }), 0), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"ps-shopping__table\">", "</div>", [_vm._ssrNode("<table class=\"table ps-table ps-table--product\">", "</table>", [_vm._ssrNode("<thead><tr><th class=\"ps-product__remove\"></th> <th class=\"ps-product__thumbnail\"></th> <th class=\"ps-product__name\">Product name</th> <th class=\"ps-product__meta\">Unit price</th> <th class=\"ps-product__quantity\">Quantity</th> <th class=\"ps-product__subtotal\">Subtotal</th></tr></thead> "), _vm._ssrNode("<tbody>", "</tbody>", [_vm._l(_vm.cartProducts, function (product, index) {
    ...
    }, [_vm._v(_vm._s(product.name))])], 1), _vm._ssrNode(" <td class=\"ps-product__meta\"><span" + _vm._ssrClass(null, ['ps-product__price', product.sale_price ? 'sale' : '']) + ">" + _vm._ssrEscape("$" + _vm._s(product.sale_price ? product.sale_price : product.price)) + "</span> " + (product.sale_price ? "<span class=\"ps-product__del\">" + _vm._ssrEscape("$" + _vm._s(product.price)) + "</span>" : "<!---->") + "</td> <td class=\"ps-product__quantity\"><div class=\"def-number-input number-input safari_only\"><button class=\"minus\"><i class=\"icon-minus\"></i></button> <input min=\"0\" type=\"number\"" + _vm._ssrAttr("value", _vm.productQuantity(product)) + " class=\"quantity\"> <button class=\"plus\"><i class=\"icon-plus\"></i></button></div></td> <td class=\"ps-product__subtotal\">" + _vm._ssrEscape("$" + _vm._s(_vm.productTotal(product))) + "</td>")], 2);
  }), _vm._ssrNode(" " + (!_vm.cartProducts || !_vm.cartProducts.length ? "<tr><td colspan=\"6\">No item</td></tr>" : "<!---->"))], 2)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"ps-shopping__footer\">", "</div>", [_vm._ssrNode("<div class=\"ps-shopping__coupon\">", "</div>", [_c(VTextField["a" /* default */], {
  ...
  }), _vm._ssrNode(" <button type=\"button\" class=\"ps-btn ps-btn--primary\">Apply coupon</button>")], 2), _vm._ssrNode(" <div class=\"ps-shopping__button\"><button type=\"button\" class=\"ps-btn ps-btn--primary\">Clear All</button> <button type=\"button\" class=\"ps-btn ps-btn--primary\">Update cart</button></div>")], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-12 col-sm-5 col-md-3\">", "</div>", [_vm._ssrNode("<div class=\"ps-shopping__label\">Cart totals</div> "), _vm._ssrNode("<div class=\"ps-shopping__box\">", "</div>", [_vm._ssrNode("<div class=\"ps-shopping__row\"><div class=\"ps-shopping__label\">Subtotal</div> <div class=\"ps-shopping__price\">" + _vm._ssrEscape("$" + _vm._s(_vm.totalCart)) + "</div></div> <div class=\"ps-shopping__label\">Shipping</div> <div class=\"ps-shopping__checkbox\"><div class=\"form-check\"><input type=\"radio\" id=\"cart-free-ship\" checked=\"checked\" class=\"form-check-input\"> <label for=\"cart-free-ship\" class=\"form-check-label\">Free shipping</label></div> <div class=\"form-check\"><input type=\"radio\" id=\"cart-ship\" class=\"form-check-input\"> <label for=\"cart-ship\" class=\"form-check-label\">Local Pickup: $10.00</label></div></div> <div class=\"ps-shopping__text\">Shipping options will be updated during checkout.</div> <a href=\"#\" class=\"ps-shopping__toggle\">Calculate shipping</a> "), _vm._ssrNode("<div class=\"ps-shopping__form\"" + _vm._ssrStyle(null, null, {
    display: _vm.calculateShipping ? '' : 'none'
  }) + ">", "</div>", [_vm._ssrNode("<div class=\"ps-shopping__group\">", "</div>", [_c(VSelect["a" /* default */], {
  ...
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"ps-shopping__group\">", "</div>", [_c(VTextField["a" /* default */], {
    staticClass: "form-control ps-input",
    attrs: {
      "rounded": "",
      "placeholder": "County"
  ...
  })], 1)], 2), _vm._ssrNode(" <div class=\"ps-shopping__row\"><div class=\"ps-shopping__label\">Total</div> <div class=\"ps-shopping__price\">" + _vm._ssrEscape("$" + _vm._s(_vm.totalCart)) + "</div></div> "), _vm._ssrNode("<div class=\"ps-shopping__checkout\">", "</div>", [_c('nuxt-link', {
    staticClass: "ps-btn ps-btn--warning",
    attrs: {
      "to": "/shop/checkout"
    }
  }, [_vm._v("Proceed to checkout")]), _vm._ssrNode(" "), _c('nuxt-link', {
    staticClass: "ps-shopping__link",
    attrs: {
      "to": "/shop"
    }
  }, [_vm._v("Continue To Shopping")])], 2)], 2)], 2)], 2)])], 2), _vm._ssrNode(" "), _c('latest-product-carousel', {
    attrs: {
...
// CONCATENATED MODULE: ./pages/shop/shopping-cart.vue?vue&type=template&id=5f1d8758&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/shop/shopping-cart.vue?vue&type=script&lang=js&
...
/* harmony default export */ var shopping_cartvue_type_script_lang_js_ = ({
  layout: 'default',
  components: {
  ...
  async mounted() {
    ...
    this.latestProduct = await Object(ProductRepository["getListIdProduct"])(query);
...
// CONCATENATED MODULE: ./pages/shop/shopping-cart.vue?vue&type=script&lang=js&
 /* harmony default export */ var shop_shopping_cartvue_type_script_lang_js_ = (shopping_cartvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(0);

// CONCATENATED MODULE: ./pages/shop/shopping-cart.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  shop_shopping_cartvue_type_script_lang_js_,
  shopping_cartvue_type_template_id_5f1d8758_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var shopping_cart = __webpack_exports__["default"] = (component.exports);
